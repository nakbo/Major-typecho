...
<div class="post-footer">
    <ul class="author-tool">
        <li>
            <button class="mdui-btn mdui-ripple mdui-color-white" mdui-menu="{target: '#maj-rewards'}"><i class="mdui-icon ion-plus-circled material-icons">attach_money</i>点击打赏</button>
            <div class="mdui-menu" id="maj-rewards">
                <div id="rewards-box"></div>
            </div>
        </li>
        <li>
            <button class="mdui-btn mdui-ripple mdui-color-white" mdui-menu="{target: '#maj-share'}"><i class="mdui-icon material-icons">share</i>点击分享</button>
