        ...
        <article id="<?php $comments->theId(); ?>" class="comment-body">
            <footer class="comment-meta">
                ...
                <div class="comment-metadata">
                    <a href="" itemprop="url">
                        <time><?php $comments->date('M j, Y'); ?></time>
                    </a>
                </div>
                <!-- .comment-metadata -->
...
<div id="comments">
    ...
    <?php if($this->allow('comment')): ?>
        <div id="<?php $this->respondId(); ?>" class="respond">
            ...
            <h3 id="response" class="comment-reply-title">
                <span>发表评论</span>
            ...
            <form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" class="comment-form" role="form">
                ...
                <div class="comment-form-main">
                    ...
                    <p class="form-submit">
                        <button name="submit" type="submit" id="submit" class="submit" title="发表评论"><svg class="icon" aria-hidden="true"><use xlink:href="#icon-send"></use></svg></button>
