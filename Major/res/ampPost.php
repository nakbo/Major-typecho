    ...
    <script type="application/ld+json">
          {
            ...
            "image": {
             ...
             "publisher": {
              ...
              "logo": {
                "@type": "ImageObject",
                "url": "https://krait.cn/usr/Major/images/logo-black-green.png",
                "width": 60,
                "height": 60
              }
            },
...
<body>
<header class="header"><div class="header-title"><h1><a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a></h1></div></header>
