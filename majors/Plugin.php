...
class majors_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Typecho_Plugin::factory('Widget_Abstract_Contents')->markdown = array('majors_Plugin', 'markdown');
        Typecho_Plugin::factory('Widget_Abstract_Comments')->markdown = array('majors_Plugin', 'markdown');
    ...
    {
        require_once dirname(__FILE__) . '/HyperDown.php';
        $HyperDown = new HyperDown();
        return $HyperDown->makeHtml($text);
    }
